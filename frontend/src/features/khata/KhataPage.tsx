                                ...
                                <button
                                  onClick={() => {
                                    ...
                                    const invoiceData = {
                                      ...
                                      sellerState: (activeParty as Mahajan).state || log?.sellerState || '',
                                      sellerStateCode: (activeParty as Mahajan).stateCode || log?.sellerStateCode || '',
                                      ...
                                      buyerState: log?.buyerState || '',
                                      buyerStateCode: log?.buyerStateCode || '',
                                      items: Array.isArray(itemsList) ? itemsList : [],
                                      subtotal: inv.subtotal,
                                      totalGst: inv.totalGst,
                                      totalAmount: inv.totalAmount,
